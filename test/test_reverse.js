...
db.metadata.embeddeds.drop();
db.metadata.embeddeds.insert({referrer: {collection: 'test_documents', field: 'author'},
  master: {collection: 'test_users', fields: ['name.first', 'age'], map: "{\"name.first\": \"name.firstname\"}"}});
sleep(300);
db.test_users.drop();
